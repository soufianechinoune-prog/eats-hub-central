-- Rewrite get_ads_revenue_ratio to use sargable timestamp bounds (uses idx_orders_restaurant_datetime)
...
-- Partial index to make ads lookup nearly instant
CREATE INDEX IF NOT EXISTS idx_payout_adjustments_ads_restaurant_date
  ON public.payout_adjustments (restaurant_id, payout_date)
