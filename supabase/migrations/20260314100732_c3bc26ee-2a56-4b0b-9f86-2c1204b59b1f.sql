...
BEGIN
  ...
  SELECT
    ...
    COUNT(*) FILTER (WHERE COALESCE(o.marketing_fee_adjustment, 0) != 0)::bigint as taxed_orders,
    COALESCE(SUM(ABS(COALESCE(o.marketing_fee_adjustment, 0))), 0)::numeric as total_offer_fees,
