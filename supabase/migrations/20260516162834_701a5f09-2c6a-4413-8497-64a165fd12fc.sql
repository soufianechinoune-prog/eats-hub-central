CREATE OR REPLACE FUNCTION public.get_orders_commission_by_fulfillment(p_restaurant_ids uuid[], p_start_date date, p_end_date date)
 RETURNS TABLE(day date, restaurant_id uuid, channel text, order_count bigint, sales_incl_vat numeric, item_promo_incl_vat numeric, uber_fee_before_promo_excl_vat numeric, uber_fee_after_promo_excl_vat numeric)
 LANGUAGE sql
