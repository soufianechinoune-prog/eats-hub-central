      ...
      <div className="space-y-6">
        ...
        {(hasPartial || prevIncomplete) && (
          <Alert>
            ...
            <AlertDescription>
              {hasPartial && <>Le mois en cours est partiel : il est {includePartialMonth ? "affiché mais exclu du périmètre constant LFL" : "exclu des totaux et du périmètre constant LFL"}. </>}
