...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      chataigne_order_items: {
        Row: {
          chain_id: string
          chataigne_location_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "chataigne_order_items_chain_id_fkey"
            columns: ["chain_id"]
            isOneToOne: false
            referencedRelation: "chains"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "chataigne_order_items_restaurant_id_fkey"
            columns: ["restaurant_id"]
            isOneToOne: false
            referencedRelation: "restaurants"
            referencedColumns: ["id"]
      ...
      chataigne_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "chataigne_orders_chain_id_fkey"
            columns: ["chain_id"]
            isOneToOne: false
            referencedRelation: "chains"
            referencedColumns: ["id"]
      ...
      notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_chain_id_fkey"
            columns: ["chain_id"]
            isOneToOne: false
            referencedRelation: "chains"
            referencedColumns: ["id"]
      ...
      weekly_report_recipients: {
        ...
        Relationships: [
          {
            foreignKeyName: "weekly_report_recipients_chain_id_fkey"
            columns: ["chain_id"]
            isOneToOne: false
            referencedRelation: "chains"
            referencedColumns: ["id"]
      ...
      weekly_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "weekly_reports_chain_id_fkey"
            columns: ["chain_id"]
            isOneToOne: false
            referencedRelation: "chains"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_orders_finance_yearly_detail: {
        Args: { p_restaurant_ids?: string[]; p_year: number }
        Returns: {
          delivery_promo_excl_vat: number
          delivery_promo_incl_vat: number
      ...
      get_restaurant_cash_revenue_v2: {
        Args: {
          p_chain_id: string
          p_end_date: string
          p_restaurant_ids: string[]
      ...
      get_weekly_uber_report: {
        Args: { p_chain_id: string; p_week_end: string; p_week_start: string }
        Returns: Json
      }
